...
This program is intended to automate multiple things for a friend of mine while DM'ing a party for D&D.
The code currently has support for:
  Tracking names of people
  Tracking health of people
  Healing players
  Damaging players
  Rolling for initiative and ordering people in the order that their turn will be
  Password protection so that only the DM can use it


  In order to access, simply input your password, and follow the instructions.
  Type "help" if you need help as to what to do.
*/


public class dnd
{
   //Establish the keyboard that will be used throughout the program
   ...
   public static void main(String[] args)
    {
      ...
      if(password.equals("xd"))
      {
        ...
        //Keeps the user inside the while loop while providing an option to exit it
        boolean itDo = true;

        //Init the player list before being able to do anything with the player list
